@extends('sTask::index')
@section('header')
    <button onclick="discoverWorkers()" class="s-btn s-btn--primary">
        <i data-lucide="search" class="w-4 h-4"></i>@lang('sTask::global.discover_workers')
    </button>
@endsection
@section('content')
    <section class="p-6">
        <div class="rounded-2xl bg-white/70 ring-1 ring-blue-200 darkness:bg-[#0f2645] darkness:bg-opacity-60 darkness:ring-[#113c6e]">
            ...
            @else
                <div class="p-6 text-center">
                    ...
                    <button onclick="discoverWorkers()" class="mt-4 s-btn s-btn--primary">
                        <i data-lucide="search" class="w-4 h-4"></i>@lang('sTask::global.discover_workers')
                    </button>
                </div>
            @endif
