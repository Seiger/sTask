    ...
    public function up(): void
    {
        ...
        */
        Schema::create('s_tasks', function (Blueprint $table) {
            ...
            $table->string('slug')->unique()->comment('Unique identifier for the integration (e.g., "simpexpcsv", "payment_stripe")');
        ...
        Schema::create('s_task_logs', function (Blueprint $table) {
